...
import { RegisterDto, LoginDto, GoogleLoginDto, ForgotPasswordDto, ResetPasswordDto } from './dto';
...
export class AuthController {
  ...
  /** Envoie le lien de réinitialisation. Répond pareil pour un e-mail inconnu. */
