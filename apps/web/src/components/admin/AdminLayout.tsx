        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-4 space-y-1.5 overflow-y-auto">
            {navigation.map((item) => (
              ...
              >
                <div
                  className={`${isActive(item.path) ? 'text-white' : 'text-gray-400 group-hover:text-primary-500'} transition-colors`}
                >
            ...
            <div>
              ...
              >
                <div
                  className={`${manageSubmenu.some((item) => isActive(item.path)) ? 'text-white' : 'text-gray-400 group-hover:text-primary-500'} transition-colors`}
                >
              ...
              {/* Submenu */}
              <div
                className={`overflow-hidden transition-all duration-300 ${isManageMenuOpen ? 'max-h-96 mt-1' : 'max-h-0'}`}
              >
