      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 animate-slide-up">
            <span className="block text-white mb-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{t('home.hero.title')}</span>
            <span className="block text-gradient drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">{t('home.hero.subtitle')}</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center mb-12 md:mb-16 animate-slide-up animation-delay-400">
            <Link to="/services" className="btn-primary text-base md:text-lg px-8 md:px-10 py-3 md:py-4 w-full sm:w-auto">
            ...
            <Link to="/services" className="btn-secondary text-base md:text-lg px-8 md:px-10 py-3 md:py-4 w-full sm:w-auto">
              {t('home.hero.explore')}
            </Link>
          </div>
