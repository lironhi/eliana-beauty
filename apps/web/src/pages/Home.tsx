...
export default function Home() {
  ...
  useEffect(() => {
    loadServices();
  }, [locale]); // Ajout de locale comme dépendance
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100">
        {/* Video Background - Full screen on both mobile and desktop */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Desktop: Video as background with gradient sides */}
          <div className="hidden lg:block absolute inset-0">
            ...
            {/* Gradient overlays on sides to blend and darken */}
            <div className="absolute inset-0 bg-gradient-to-r from-black/40 via-black/20 via-50% to-black/40"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/30"></div>
          </div>

          {/* Mobile/Tablet: Video as full background with overlay */}
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="decorative-blob w-96 h-96 bg-pink-300 -top-20 -left-20"
            style={{ animationDelay: '0s' }}
          ></div>
          <div
            className="decorative-blob w-80 h-80 bg-purple-300 top-40 -right-20"
            style={{ animationDelay: '2s' }}
          ></div>
          <div
            className="decorative-blob w-72 h-72 bg-pink-200 -bottom-10 left-1/3"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 animate-slide-up">
            <span className="block text-white mb-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              {t('home.hero.title')}
            </span>
            <span className="block text-gradient drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
              {t('home.hero.subtitle')}
            </span>
          </h1>

          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white mb-12 max-w-3xl mx-auto animate-slide-up animation-delay-200 leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
            {t('home.hero.description')}
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center mb-12 md:mb-16 animate-slide-up animation-delay-400">
            <Link
              to="/services"
              className="btn-primary text-base md:text-lg px-8 md:px-10 py-3 md:py-4 w-full sm:w-auto"
            >
              {t('home.hero.bookAppointment')}
              <svg
                className="inline-block ml-2 w-4 h-4 md:w-5 md:h-5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <Link
              to="/services"
              className="btn-secondary text-base md:text-lg px-8 md:px-10 py-3 md:py-4 w-full sm:w-auto"
            >
              {t('home.hero.explore')}
            </Link>
          </div>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 animate-slide-up animation-delay-600">
            <div className="flex items-center gap-3 text-white drop-shadow-lg">
              ...
              <div className="text-left">
                <div className="font-bold text-base md:text-lg">5.0</div>
                <div className="text-xs md:text-sm text-white/90">{t('home.trust.rating')}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-white drop-shadow-lg">
              ...
              <div className="text-left">
                <div className="font-bold text-base md:text-lg">2000+</div>
                <div className="text-xs md:text-sm text-white/90">{t('home.trust.clients')}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-white drop-shadow-lg">
              ...
              <div className="text-left">
                <div className="font-bold text-base md:text-lg">100%</div>
                <div className="text-xs md:text-sm text-white/90">{t('home.trust.quality')}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-premium gradient-mesh">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 scroll-fade-in">
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              {t('home.whyChoose.title')}{' '}
              <span className="text-gradient">{t('home.whyChoose.titleHighlight')}</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="section-premium bg-gradient-to-br from-pink-500 via-purple-600 to-pink-600 text-white animate-gradient">
        <div className="max-w-4xl mx-auto text-center scroll-fade-in">
          ...
          <p className="text-xl mb-10 opacity-90">{t('home.cta.subtitle')}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">{t('home.hero.description')}</p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a
                    href="https://maps.google.com/?q=רמבם 46 דירה 5 באר שבע"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    ...
                    <span className="flex flex-col">
                      <span dir="rtl">רמב"ם 46 דירה 5, באר שבע</span>
                      <span className="text-xs">Rambam 46, Apt 5, Beer Sheva</span>
                    </span>
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} {t('home.hero.title')}. {t('home.footer.rights')}.
            </p>
          </div>
        </div>
      </footer>
