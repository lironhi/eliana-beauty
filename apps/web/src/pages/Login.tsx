  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-pink-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/3 -right-32 w-80 h-80 bg-gradient-to-br from-purple-200/20 to-pink-200/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className="absolute -bottom-32 left-1/3 w-96 h-96 bg-gradient-to-br from-pink-200/25 to-purple-200/25 rounded-full blur-3xl animate-pulse"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 text-3xl opacity-20 animate-float"
          style={{ animationDelay: '1s' }}
        >
          ✨
        </div>
        <div
          className="absolute bottom-32 left-20 text-3xl opacity-20 animate-float"
          style={{ animationDelay: '2s' }}
        >
          💄
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="text-center">
              <p className="text-gray-600 text-sm mb-3">{t('auth.noAccount')}</p>
              <Link
                to="/register"
