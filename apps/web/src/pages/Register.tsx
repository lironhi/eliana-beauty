...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-pink-50">
      ...
      <div className="absolute top-40 right-20 text-4xl opacity-20 animate-float delay-1000">
        ✨
      </div>
      <div className="absolute bottom-32 left-20 text-4xl opacity-20 animate-float delay-2000">
        💄
      </div>
      <div className="absolute bottom-20 right-32 text-4xl opacity-20 animate-float delay-3000">
        💐
      </div>
