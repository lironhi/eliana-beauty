      ...
      <div className="bg-white/50 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 md:py-4">
          <div className="flex items-center gap-1.5 md:gap-2 text-xs md:text-sm text-gray-600 overflow-x-auto">
            <Link to="/" className="hover:text-pink-600 transition-colors whitespace-nowrap">
              {t('serviceDetail.breadcrumb.home')}
            </Link>
            <svg
            ...
            >
              {t('serviceDetail.breadcrumb.services')}
            </Link>
            <svg
              className="w-3 h-3 md:w-4 md:h-4 flex-shrink-0"
              fill="none"
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-4 animate-fade-in animation-delay-200">
              <div className="card p-2 md:p-4 text-center">
                <svg
                  className="w-5 h-5 md:w-8 md:h-8 mx-auto mb-1 md:mb-2 text-pink-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="font-bold text-gray-900 text-xs md:text-base">
                  {service.durationMin} {t('services.minutes')}
                </div>
                <div className="text-[10px] md:text-xs text-gray-500">
                  {t('serviceDetail.features.duration')}
                </div>
              </div>

              <div className="card p-2 md:p-4 text-center">
                <svg
                  className="w-5 h-5 md:w-8 md:h-8 mx-auto mb-1 md:mb-2 text-purple-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="text-[10px] md:text-xs text-gray-500">
                  {t('serviceDetail.features.staff')}
                </div>
              </div>
              ...
              <div className="card p-2 md:p-4 text-center">
                ...
                <div className="font-bold text-gray-900 text-xs md:text-base">
                  {t('serviceDetail.features.quality')}
                </div>
                <div className="text-[10px] md:text-xs text-gray-500 hidden sm:block">
                  {t('serviceDetail.trustBadge.title')}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-fade-in animation-delay-300">
            <span className="badge-premium mb-3 md:mb-4 text-xs md:text-sm">
            ...
            <div className="flex items-baseline gap-3 md:gap-4 mb-6 md:mb-8">
              <div className="text-3xl md:text-5xl font-bold text-gradient">
                {service.priceFrom && (
                  <span className="text-xl md:text-2xl font-normal mr-2">{t('common.from')}</span>
                )}
                ₪{service.priceIls}
              </div>
            ...
            <div className="mt-6 md:mt-8 flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-green-50 border border-green-200 rounded-lg md:rounded-xl">
              <svg
                className="w-6 h-6 md:w-8 md:h-8 text-green-500 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
              ...
              <div>
                ...
                <div className="text-xs md:text-sm text-green-700">
                  {t('serviceDetail.trustBadge.description')}
                </div>
              </div>
            </div>
          </div>
      ...
      {relatedServices.length > 0 && (
        <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-12 md:pb-20">
          <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-8 text-center">
            {t('serviceDetail.relatedServices.title')}{' '}
            <span className="text-gradient">
              {t('serviceDetail.relatedServices.titleHighlight')}
            </span>
          </h2>
                ...
                <div className="p-4 md:p-6">
                  ...
                  <div className="flex items-center justify-between pt-3 md:pt-4 border-t border-gray-100">
                    <span className="text-sm md:text-base text-gray-600">
                      {relatedService.durationMin} min
                    </span>
                    <span className="text-lg md:text-xl font-bold text-gradient">
                      {relatedService.priceFrom && (
                        <span className="text-sm font-normal mr-1">{t('common.from')}</span>
                      )}
