...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-4 md:space-y-6 lg:space-y-8">
      {/* Enhanced Header with Time - More compact on mobile */}
      ...
      {/* Enhanced Stats Grid - More compact on mobile */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
        {stats.map((stat, index) => (
          <div
            key={stat.name}
            className="card-premium hover-lift scroll-fade-in group relative overflow-hidden border-2 border-transparent hover:border-gradient p-4 md:p-5 lg:p-6"
          ...
          >
            ...
            <div className="relative flex items-center justify-between gap-3">
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-600 mb-1 md:mb-2 tracking-wide uppercase flex items-center gap-1 md:gap-2 flex-wrap">
                  <span className="truncate">{stat.name}</span>
                  {index === 0 && (
                    <span className="inline-flex items-center px-1.5 md:px-2 py-0.5 rounded-full text-[9px] md:text-[10px] font-bold bg-red-100 text-red-700 animate-pulse flex-shrink-0">
                      TODAY
                    </span>
                  )}
                </p>
                <div className="flex items-baseline gap-1 md:gap-2 flex-wrap">
                  <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gradient group-hover:scale-110 transition-transform duration-300 inline-block">
                    {stat.value}
                  </p>
            ...
            <div className="absolute -bottom-3 -right-3 w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-pink-200/20 to-purple-200/20 rounded-full blur-xl md:blur-2xl group-hover:scale-150 group-hover:blur-3xl transition-all duration-700"></div>
            <div className="absolute -top-3 -left-3 w-12 h-12 md:w-20 md:h-20 bg-gradient-to-br from-purple-200/15 to-blue-200/15 rounded-full blur-lg md:blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
        ...
        <div className="card-premium overflow-hidden group scroll-fade-in shadow-lg md:shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-pink-200">
          {/* Gradient overlay - like quick actions */}
          <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>

          <div className="p-4 md:p-5 lg:p-7 border-b-2 border-gradient bg-gradient-to-r from-pink-50 via-purple-50 to-pink-50 relative overflow-hidden">
            {/* Shine effect - like quick actions */}
            ...
            <div className="flex items-center justify-between relative gap-2 md:gap-3">
              ...
              <Link
                ...
                className="text-xs md:text-sm text-white bg-gradient-to-r from-pink-500 to-purple-600 px-3 md:px-4 py-1.5 md:py-2 rounded-lg hover:shadow-lg font-medium flex items-center gap-1 transition-all hover:gap-2 group/link flex-shrink-0"
              >
        ...
        <div className="card-premium overflow-hidden group scroll-fade-in shadow-lg md:shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-purple-200">
          {/* Gradient overlay - like quick actions */}
          ...
          <div className="p-4 md:p-5 lg:p-7 border-b-2 border-gradient bg-gradient-to-r from-purple-50 via-pink-50 to-purple-50 relative overflow-hidden">
            {/* Shine effect - like quick actions */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
            ...
            <div className="flex items-center justify-between relative gap-2">
              ...
              <div className="px-2 md:px-3 py-1 md:py-1.5 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-md md:rounded-lg text-[10px] md:text-xs font-semibold text-orange-700 flex-shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <LineChart
          ...
          color="#8b5cf6"
          showFilters={true}
          data={(data.appointmentsTrend || []).map((item: any) => ({
            label: item.label,
            value: item.value,
      ...
      <div className="card-premium scroll-fade-in relative overflow-hidden shadow-lg md:shadow-xl p-4 md:p-6 lg:p-8">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 lg:gap-5">
            <Link
              to="/admin/appointments"
              className="p-4 md:p-5 lg:p-7 card-glass hover-lift group text-center relative overflow-hidden border-2 border-transparent hover:border-pink-200 transition-all duration-300"
            >
              {/* Gradient overlay */}
            ...
            <Link
              to="/admin/clients"
              className="p-4 md:p-5 lg:p-7 card-glass hover-lift group text-center relative overflow-hidden border-2 border-transparent hover:border-blue-200 transition-all duration-300"
            >
              ...
              <div className="relative">
                ...
                <p className="text-[9px] md:text-[10px] lg:text-xs text-gray-500">View customers</p>
              </div>
            </Link>

            <Link
              to="/admin/services"
              className="p-4 md:p-5 lg:p-7 card-glass hover-lift group text-center relative overflow-hidden border-2 border-transparent hover:border-purple-200 transition-all duration-300"
            >
            ...
            <Link
              to="/admin/staff"
              className="p-4 md:p-5 lg:p-7 card-glass hover-lift group text-center relative overflow-hidden border-2 border-transparent hover:border-indigo-200 transition-all duration-300"
            >
              ...
              <div className="relative">
                ...
                <p className="text-[9px] md:text-[10px] lg:text-xs text-gray-500">Manage team</p>
              </div>
            </Link>
          </div>
        </div>
