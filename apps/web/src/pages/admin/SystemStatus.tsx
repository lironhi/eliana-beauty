...
export default function SystemStatus() {
  ...
  const handleBackup = async () => {
    if (
      !confirm(
        'Are you sure you want to create a database backup? This operation may take a few moments.',
      )
    ) {
      return;
    }
  ...
  const handleRestore = async () => {
    if (
      !confirm(
        '⚠️ WARNING: This will restore the database from the last backup. All current data will be replaced. Are you absolutely sure?',
      )
    ) {
      return;
    }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-800">
                  Backing up the database is recommended before major updates. Restoring will
                  replace current data with backup data. Always ensure you have a recent backup
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-800">
                      This will restore data from the last backup. All current data in selected
                      tables will be PERMANENTLY REPLACED. This action cannot be undone!
                    </p>
                  </div>
                </div>
              </div>
